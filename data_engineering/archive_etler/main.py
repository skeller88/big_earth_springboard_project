...
def main():
    ...
    if should_compute_band_stats:
        ...
        # filenames = [os.path.join(extraction_path, file, f"{file}_B{{}}.tif") for file in train_set[0].values]
        # stats = stats_for_tiff_images(filenames=filenames)
        # stats_filepath = metadata_path + '/band_stats_tiff.csv'
